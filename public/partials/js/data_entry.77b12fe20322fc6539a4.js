          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return axios.get("/web/data-entry/sites/".concat(_this2.site, "/plots"), {
                  params: {
                    limit: _this2.limit,
                    plot: _this2.plotFilter,
                    search: _this2.search,
                    sort_order: _this2.sortOrder
                  },
                  cancelToken: new axios.CancelToken(function (fn) {
                    return _this2._request = fn;
                  })
                });
              ...
              case 9:
                ...
                if (!axios.isCancel(_context2.t0)) {
                  _this2.$alert('Unable to load plots. Please try refreshing the page or contact us.');

                  console.error(_context2.t0);
                }

              case 12:
                _this2.loadingPlots = false;
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    _this5.deleting = measurement.id;
                    _context5.prev = 1;
                    _context5.next = 4;
    ...
    if (this.formsSet > 0) {
      this.$confirm({
        ...
        onConfirm: function onConfirm() {
          window.removeEventListener('beforeunload', _this6.beforeUnload.bind(_this6), false);
          next();
        }
      });
    } else {
