  ...
  methods: {
    ...
    merge: function merge() {
      ...
      this.$confirm({
        ...
        text: "This action is not reversible. Please confirm merging ".concat(this.selected.length, " species by clicking confirm below."),
        onConfirm: function () {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "card mb-3" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm.selected.length > 0
              ? _c("div", { staticClass: "flex-grow-1 text-muted pl-2" }, [
                  _vm._v(
                    "\n        " +
      ...
      _vm._v(" "),
      _vm.selected.length > 1
        ? _c("div", { staticClass: "floating-button" }, [
            _c(
              "button",
              {
                staticClass: "btn btn-info",
