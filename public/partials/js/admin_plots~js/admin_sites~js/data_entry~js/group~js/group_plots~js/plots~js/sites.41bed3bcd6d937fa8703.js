...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    var option = new Option('hello', 1, false, false);
    console.log(this.$refs["".concat(this.id, "_select")]); // this.$refs[`${this.id}_select`].append(option).trigger('change')

    console.log('here'); // const select = this.$refs.select
    //
    // console.log(select)
    //
    // const option = new Option(this.selections.name, this.selections.id, true, true)
    // select.options.append(option).trigger('change')
  },
  data: function data() {
    return {
      selects: []
      ...
      return {
        ...
        data: function data(params) {
          return {
            search: params.term,
            page: params.page || 1,
            selections: this.selections ? this.selections.map(function (_ref) {
              var id = _ref.id;
              return id;
            }) : null
          };
        ...
        processResults: function processResults(data, params) {
          ...
          return {
            results: data.data.map(function (_ref2) {
              var id = _ref2.id,
                  name = _ref2.name;
              return {
                id: id,
