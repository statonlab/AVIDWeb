        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _this.options = data.data.map(function (_ref2) {
                var id = _ref2.id,
                    name = _ref2.name;
                return {
                  id: id,
              ...
              _this.selects = data.data.map(function (_ref3) {
                var id = _ref3.id;
                return id;
              });
              console.log(select);
      ...
      return {
        ...
        data: function data(params) {
          return {
            search: params.term,
            page: params.page || 1,
            selections: this.selections ? this.selections.map(function (_ref4) {
              var id = _ref4.id;
              return id;
            }) : null
          };
        ...
        processResults: function processResults(data, params) {
          ...
          return {
            results: data.data.map(function (_ref5) {
              var id = _ref5.id,
                  name = _ref5.name;
              return {
                id: id,
