...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {// const {data} = axios.get(this.url, {
    //   params: {
    //     selections: this.selects,
    //   }
    // })
    //
    // this.options = data.data.map(({id, name}) => ({id, text: name}))
  },
  computed: {
    ajax: function ajax() {
      if (!this.url) {
      ...
      [
        _c(
          ...
          [
            _c(
              "option",
              { attrs: { value: "3620194", selected: "selected" } },
