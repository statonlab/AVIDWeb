            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                axios.get('/web/species', {
                  ...
                  _this3.speciesOptions = response.data.map(function (_ref3) {
                    var id = _ref3.id,
                        name = _ref3.name;
                    return {
                      id: id,
