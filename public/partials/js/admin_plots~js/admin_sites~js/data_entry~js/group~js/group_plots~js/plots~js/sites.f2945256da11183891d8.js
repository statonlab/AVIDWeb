...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var select, _yield$axios$get, data;
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return axios.get(_this.url, {
                params: {
                  selections: _this.selections.map(function (_ref) {
                    var id = _ref.id;
                    return id;
                  })
                }
            ...
            case 3:
              ...
              console.log(select.select2[0].options);
              data.data.forEach(function (selection) {
                var option = new Option(selection.name, selection.id, true, true);
                select.select2[0].options.append(option).trigger('change');
              });
      ...
      return {
        ...
        data: function data(params) {
          return {
            search: params.term,
            page: params.page || 1,
            selections: this.selections ? this.selections.map(function (_ref2) {
              var id = _ref2.id;
              return id;
            }) : null
          };
