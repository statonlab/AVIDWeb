    ...
    [
      _c("div", { staticClass: "card mb-3" }, [
        _c("div", { staticClass: "card-header d-flex p-2" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "ml-auto flex-shrink-0 pl-1" }, [
            _c(
              "button",
              {
                ...
                [
                  ...
                  _c(
                    ...
                    _vm._l(_vm.sites, function(site) {
                      return _c(
                        "tr",
                        { class: { "on-hover": _vm.deleting !== site.id } },
                        [
                          _c(
                            "td",
                            [
                            ...
                            [
                              _c(
                                "router-link",
                                {
                                  ...
                                  staticClass:
                                    "show-on-hover btn btn-link btn-sm",
                                  attrs: {
                                    to: _vm.siteUrlPrefix + "/" + site.id
                                  }
                                },
                              ...
                              _vm.User.can("delete sites")
                                ? _c(
                                    "button",
                                    {
                                      ...
                                      staticClass:
                                        "show-on-hover btn btn-link btn-sm mr-1",
                                      on: {
                                        click: function($event) {
                                          $event.preventDefault()
