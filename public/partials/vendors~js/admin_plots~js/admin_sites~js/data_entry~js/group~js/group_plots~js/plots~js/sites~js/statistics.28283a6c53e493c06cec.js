(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~js/admin_plots~js/admin_sites~js/data_entry~js/group~js/group_plots~js/plots~js/sites~js/statistics"],{
