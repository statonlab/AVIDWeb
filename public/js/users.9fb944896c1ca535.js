        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log('downloading users'); // const {data} = await axios.get(`/web/users/page/export`)
                ...
                Object.keys(params).forEach(function (key) {
                  joined.push("".concat(key, "=").concat(params[key] || ''));
                });
                return _context2.abrupt("return", "/web/users/page/export?".concat(joined.join('&')));
...
var render = function render() {
  ...
  }), _vm._v(" "), _c("span", [_vm._v("Download Sheet")])], 1), _vm._v(" "), _c("a", {
  ...
  }), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.$t("general.download")))])], 1), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.verified,
