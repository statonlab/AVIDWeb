          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return axios.get("/web/users/export");
            ...
            [
              ...
              _c(
                "a",
                {
                  ...
                  attrs: { href: "/web/users/export", target: "_blank" },
                },
                [
              ...
              _c(
                "select",
                {
                  ...
                  on: {
                    change: function ($event) {
                      ...
                      _vm.verified = $event.target.multiple
                        ? $$selectedVal
                        : $$selectedVal[0]
                    },
                  },
                ...
                [
                  ...
                  _c("option", { attrs: { value: "verified" } }, [
                    _vm._v("Show verified emails"),
                  ]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "unverified" } }, [
                    _vm._v("Show only unverified emails"),
                  ]),
                ]
              ),
            ]
