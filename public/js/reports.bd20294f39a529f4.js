              ...
              case 10:
                ...
                if (!axios.isCancel()) {
                  if (_context.t0.response && _context.t0.response.status === 422) {
                    ...
                    _this.$alert('Unable to load data. Please try refreshing the page or contact us.');
                  }
...
var render = function render() {
  ...
  }, [_vm.wmu.length === 0 ? _c("span", [_vm._v(" No sites found")]) : _vm._e(), _vm._v(" "), _vm.wmu.length > 0 ? _c("table", {
  ...
  })], 1)])])]), _vm._v(" "), _c("tbody", _vm._l(_vm.wmu, function (item) {
    return _c("tr", [_c("td", [_vm._v("\n            " + _vm._s(item.aggregate_wmu ? item.aggregate_wmu : "None") + "\n          ")]), _vm._v(" "), _c("td", [_vm._v("\n            " + _vm._s(item.total) + "\n          ")])]);
  }), 0)]) : _vm._e()]) : _vm._e()], 1)]);
};
