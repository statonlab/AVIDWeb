...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.loadPlant();
    this.loadMeasurements(); // if (! this.User.owns(this.plant.site)) {
    //   this.loadUserSite()
    // }
  },
  watch: {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios.get("/web/user-sites/site/".concat(_this3.plant.site.id));

              case 3:
                _yield$axios$get3 = _context3.sent;
                data = _yield$axios$get3.data;
                _this3.sharedEdit = data.editable;
                _context3.next = 11;
                break;
