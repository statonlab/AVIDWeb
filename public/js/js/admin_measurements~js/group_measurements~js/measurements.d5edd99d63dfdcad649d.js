        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _this.loadPlant();

            case 3:
              if (!_this.User.owns(_this.plant.site)) {
                _this.loadUserSite();
              }
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return axios.get("/web/plants/".concat(id, "/measurements"), {
                  params: {
                    order_by: _this3.orderBy,
                    order_dir: _this3.orderDir,
                    page: _this3.page
                  }
                });
              ...
              case 4:
                ...
                _this3.measurements = data.data;
                _this3.lastPage = data.last_page;
              ...
              case 11:
                ...
                _this3.unauthorized = true;
                _this3.loadingMeasurements = false;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return axios.get("/web/user-sites/site/".concat(_this4.plant.site.id));

              case 3:
                _yield$axios$get3 = _context4.sent;
                data = _yield$axios$get3.data;
                _this4.sharedEdit = data.editable;
                _context4.next = 11;
                break;
              ...
              case 8:
                ...
                if (_context4.t0.response && _context4.t0.response.status === 500) {
                  _this4.$notify({
