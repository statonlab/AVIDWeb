...
/* harmony import */ var _forms_OwnerForm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../forms/OwnerForm */ "./resources/js/forms/OwnerForm.vue");
/* harmony import */ var _InlineSpinner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./InlineSpinner */ "./resources/js/components/InlineSpinner.vue");
/* harmony import */ var _helpers_User__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../helpers/User */ "./resources/js/helpers/User.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'BetaPlotsView',
  components: {
    InlineSpinner: _InlineSpinner__WEBPACK_IMPORTED_MODULE_10__["default"],
    ...
    OwnerForm: _forms_OwnerForm__WEBPACK_IMPORTED_MODULE_9__["default"],
  ...
  data: function data() {
    return {
      User: _helpers_User__WEBPACK_IMPORTED_MODULE_11__["default"],
      loading: true,
      plots: [],
      plot: null,
      plotId: null,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _this2.sharedEdit = data.editable;
  ...
  methods: {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios.put("/web/user-sites/site/".concat(_this3.site.id, "/user/").concat(user.id, "/toggle-edit"));

              case 3:
                _yield$axios$put = _context3.sent;
                data = _yield$axios$put.data;
                _this3.sharedWith = _this3.sharedWith.map(function (u) {
    ...
    cancelShare: function cancelShare(user) {
      ...
      this.$confirm({
        ...
        text: 'This action is permanent.',
        onConfirm: function () {
          var _onConfirm = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4() {
            var errors;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.prev = 0;
                    _context4.next = 3;
                    return axios["delete"]("/web/user-sites/site/".concat(_this4.site.id, "/user/").concat(user.id));

                  case 3:
                    _this4.sharedWith = _this4.sharedWith.filter(function (u) {
                      return u.id !== user.id;
                    });
                  ...
                  case 7:
                    ...
                    } else if (_context4.t0.response && _context4.t0.response.status === 422) {
                      errors = new _forms_Errors__WEBPACK_IMPORTED_MODULE_1__["default"](_context4.t0.response.data);

                      _this4.$alert(errors.toArray().join(' '));
                    } else {
                      _this4.$notify({
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _this2.form.post("/web/sites/".concat(_this2.site.id, "/change-owner"));
      ...
      _c("div", { staticClass: "row" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm.User.can("share sites") || _vm.User.owns(_vm.site)
              ? _c("site-sharing-card", { attrs: { site: _vm.site } })
              : _vm._e()
          ],
          1
        ),
                          ...
                          _vm.plot
                            ? _c("beta-plants-view", {
                                attrs: {
                                  ...
                                  editable: _vm.sharedEdit || _vm.editable,
                                  plot: _vm.plot,
                                  site: _vm.site
                                }
                              })
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "mb-4" }, [
      _c("small", { staticClass: "text-muted" }, [
        _vm._v("Transfer ownership of this site to another user")
      ])
    ])
  }
]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c("modal-title", [
                    _vm._v("Transfer ownership of " + _vm._s(_vm.site.name))
                  ]),
                  _vm._v(" "),
                  _c("close", {
                    on: {
              ...
              _c("modal-body", { staticClass: "position-static" }, [
                _c(
                  ...
                  [
                    _c("label", [
                      _vm._v("User to Make Owner of " + _vm._s(_vm.site.name))
                    ]),
                    _vm._v(" "),
                    _c("dropdown", {
                      ref: "user",
...
/***/ "./resources/js/forms/OwnerForm.vue":
/*!******************************************!*\
  !*** ./resources/js/forms/OwnerForm.vue ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true& */ "./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true&");
/* harmony import */ var _OwnerForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OwnerForm.vue?vue&type=script&lang=js& */ "./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _OwnerForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "b85746ee",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/forms/OwnerForm.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js&":
/*!*******************************************************************!*\
  !*** ./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js& ***!
  \*******************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OwnerForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./OwnerForm.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/forms/OwnerForm.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OwnerForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true&":
/*!*************************************************************************************!*\
  !*** ./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true& ***!
  \*************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/forms/OwnerForm.vue?vue&type=template&id=b85746ee&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OwnerForm_vue_vue_type_template_id_b85746ee_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
