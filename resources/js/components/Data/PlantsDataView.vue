            ...
            <div class="d-flex mb-3">
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                        <router-link :to="`${backUrlPrefix}/${this.plot.site_id}`" class="btn btn-link-dark px-1 ml-n1">
                ...
                <div class="ml-auto">
                    <button class="btn btn-link" v-if="editable || User.owns(plot) || User.can('update sites')" @click.prevent="editingPlot = true">
                        <icon name="create"/>
                        <span>Edit Plot</span>
                    </button>
                </div>
      ...
      async loadPlants() {
        ...
        try {
          ...
          if (!axios.isCancel(e)) {
            ...
            console.error(e)
            this.$notify({
              text: 'Unable to load plants. Please try refreshing the page.',
              type: 'error',
            })
          }
        }
