            ...
            <div class="row">
                <div class="card col-12">
                    <div class="card-header">
                        <h1 class="page-title mb-0">Signs and Symptoms of Deer Impacts</h1>
                        <p class="text-muted">When deer are having a substantial impact on the forest, recognizable signs can be detected by the trained eye.</p>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-6">
