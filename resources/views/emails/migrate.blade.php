...
We are excited to announce that we have been working with a super-talented group of web programmers from the University of Tennessee to repackage the AVID website.
It looks similar to the original site, but has better functionality, top-end cyber security, and some very cool features (such as graphing data by year, location, county, etc.).
A summary of some of new features follows, but the key point of this email is to have you visit the new website at <a href="{!! url('/') !!}">aviddeer.com</a> and update your password.
Instructions will follow in a separate email. You can then see your data, and the exciting new features.
...
Your participation with AVID helps
<a href="https://www.scientia.global/dr-paul-curtis-dr-peter-smallidge-dr-bernd-blossey-protecting-the-future-health-of-forests-in-new-york-state/">
    protect the future health of forests in New York State
</a>.
We hope you take this opportunity to download your pre-formatted data sheets from the new site, and go make your 2020 measurements!
