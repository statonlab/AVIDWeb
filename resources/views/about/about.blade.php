                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <p>These guides describe the procedures to measure vegetation and quantify the impacts deer are having on woodland vegetation. These field methods can be used by volunteers, landowners, land managers, land trusts, foresters, and other natural resource professionals. Individuals can use <b>AVID</b> via a smartphone app for both Apple and Android phones from the <a href="https://apps.apple.com/us/app/avid-deer/id1578311148">Apple App Store</a> or the <a href="https://play.google.com/store/apps/details?id=com.aviddeer&hl=en_US&gl=US">Google Play Store</a>, or by printing field data sheets and entering the data online at <a href="http://aviddeer.com/">aviddeer.com</a>.</p>
