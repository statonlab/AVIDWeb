...
Route::get('/sanctum/user/delete-account-requests', [DeleteAccountRequestController::class, 'myIndex'])->middleware('auth:sanctum');
Route::post('/sanctum/user/delete-account-requests', [DeleteAccountRequestController::class, 'create'])->middleware('auth:sanctum');
Route::delete('/sanctum/user/delete-account-request/{deleteRequest}', [DeleteAccountRequestController::class, 'delete'])->middleware('auth:sanctum');
